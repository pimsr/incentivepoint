                        ...
                        <div class="menu-side bg2">
                            ...
                            <div class="list-reward">
                                ...
                                <ul class="list-inline">
                                    <li class="account-profile"><a href="account.php">ข้อมูลส่วนตัว</a> </li>
                                    <li class="account-address"> <a href="account-address.php">ที่อยู่ผู้รับสินค้า</a></li>
                                    <li class="account-email"> <a href="account-email.php">เปลี่ยนอีเมล</a></li>
                                    <li class="account-password"> <a href="account-change-password.php">เปลี่ยนรหัสผ่าน</a></li>
                                    <li class="account-remember"> <a href="account-remember.php">ระบบช่วยจำรหัสผ่าน</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <h6 class="color2 mb-2">เปลี่ยนอีเมล</h6>
                                            <p class="mb-0">ท่านจะได้รับอีเมลแจ้งข้อมูลข่าวสารต่างๆ เกี่ยวกับคะแนน เช่น ยืนยันการสั่งสินค้า, แจ้งคะแนนคงเหลือ และข้อมูลสินค้าต่างๆ เป็นต้น บางครั้งท่านอาจได้รับอีเมลในเวลารุ่งเช้า ดังนั้น กรุณาทำการพิจารณาหากท่านต้องการเชื่อมต่ออีเมลนี้กับมือถือของท่าน สำหรับอีเมลข้อมูลที่จะส่งไปยังบริษัท อาจมีรูปแบบที่แตกต่างกันไป ขึ้นอยู่กับลักษณะของสัญญา</p>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="hr"></div>
                                        </div>
                                ...
                                <div class="point-body form-custom pb-3">
                                    ...
                                    <div class="form-group row ">
                                        <label for="name" class="col-md-3 col-form-label"><span class="color-red">*</span>อีเมล :</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-9">
                                            <span class="color-red">*</span> กรุณากรอกอีเมลเช่น : example@mail.com  <br>
                                            <button class="btn btn-1 mt-3 alert_success" type="submit">ยืนยันข้อมูล</button>
                                        </div>
                                    </div>
