                ...
                <div class="wrapper row">
                    <div class="col-md-4 col-lg-4 col-xl-3">
                        ...
                        <div class="display py-4">
                            ...
                            <!-- <div class="row">
                                <div class="col-6">คะแนนหมดอายุ</div>
                                <div class="col-6 text-right">วันที่ <span class="color2">31 ธ.ค. 2561</span></div>
                            </div> -->
                        </div>
                        ...
                        <div class="menu-side bg2">
                            ...
                            <div class="list-reward">
                                ...
                                <ul class="list-inline">
                                    <li class="check-point"><a href="reward.php">ตรวจสอบคะแนน</a> </li>
                                    <li class="check-history"> <a href="reward-history.php">ประวัติการใช้คะแนน</a></li>
                                    <li class="check-rule"> <a href="reward-rule.php">เกณฑ์ของ Award Point</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h6 class="color2">รายละเอียดการใช้คะแนนที่ผ่านมา</h6>
                                        </div>
                                ...
                                <div class="point-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                    <div class="col-md-3">
                                                        <img class="img-fluid" src="images/product/h1.png" alt="">
                                                    </div>
                                                    <div class="col-md-9">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="mb-0">
                                                                    <div class="list-show">
                                                                        <h6>ไมโครเวฟ ดิจิตอล ELECTROLUX EMS3085X</h6>
                                                                        <p class="small">รหัสสินค้า <span class="color2">0005901263</span></p>
                                                                        เตาอบไมโครเวฟแบบผสม 2 in 1 พร้อมฟังก์ชั่นย่าง ช่วยให้คุณสะดวกสบายยิ่งขึ้น ด้วยการผสมผสานไว้ในเครื่องเดียว สามารถทำอาหารได้หลากหลาย
                                                                    </div>
                                                                </h5>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <h6 class="color2">ข้อมูลการสั่งซื้อ</h6>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="hr"></div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <table class="table table-sm bg-gray p-r-30">                                                       
                                                        <tbody>
                                                            <tr>
                                                                <td>หมายเลขสั่งซื้อ</td>
                                                                <td class="text-right"><span class="color2">1231241412-123565</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>วันที่สั่ง</td>
                                                                <td class="text-right"><span class="color2" >วันที่ 13/02/2018</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>รวม</td>
                                                                <td class="text-right"><span class="color2">100 คะแนน</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>ช่องทางการชำระ</td>
                                                                <td class="text-right"><span class="color2">ผ่านเคาน์เตอร์ (เทสโก้ โลตัส)</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>จำนวนเงินที่ต้องชำระ</td>
                                                                <td class="text-right"><span class="color2">74.00 THB</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>สถานะการชำระเงิน</td>
                                                                <td class="text-right"><span class="color2">การชำระเงินเสร็จสมบูรณ์</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>ราคาต่อหน่วย</td>
                                                                <td class="text-right"><span class="color2">174 คะแนน</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>จำนวน</td>
                                                                <td class="text-right"><span class="color2">1</span></td>
                                                            </tr>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-6">
                                                <h6 class="color2">ข้อมูลผู้รับสินค้า</h6>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="hr"></div>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-sm bg-gray p-r-30">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>ชื่อผู้รับ</td>
                                                                <td class="text-right"><span class="color2">Demo Tester</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>ชื่อบริษัท</td>
                                                                <td class="text-right"><span class="color2" >Ost Intertester</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>แผนก/สาขา</td>
                                                                <td class="text-right"><span class="color2">Engineering</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>ที่อยู่</td>
                                                                <td class="text-right"><span class="color2">1234  Baiyok Building 50th Floor…</span></td>
                                                            </tr>

                                                            <tr>
                                                                <td>จังหวัด</td>
                                                                <td class="text-right"><span class="color2">Bangkok thailand</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>ไปรษณีย์</td>
                                                                <td class="text-right"><span class="color2">10510</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>รายละเอียดผู้ติดต่อ</td>
                                                                <td class="text-right"><span class="color2"></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>เบอร์โทร 1 </td>
                                                                <td class="text-right"><span class="color2">01234-56789</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>เบอร์โทรผู้รับสินค้า</td>
                                                                <td class="text-right"><span class="color2">01234-56789</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>อีเมล์</td>
                                                                <td class="text-right"><span class="color2">topfrom@engineering.com</span></td>
                                                            </tr>
                            ...
                            <div class="h30"></div>
                            <a class="color2 underline" href="reward-history.php">ย้อนกลับ</a>
                        </div>
                    </div>
                </div>
            </div>
