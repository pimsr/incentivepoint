                        ...
                        <!-- END menu mobile -->
                            ...
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <h6 class="color2 mb-2">รายละเอียดการมอบคะแนน</h6>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm bg-gray">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>ผู้รับ</td>
                                                    <td><span class="color2">Arty Thanadda</span></td>
                                                </tr>

                                                <tr>
                                                    <td>ชื่อกลุ่ม</td>
                                                    <td><span class="color2">10</span> ICDemo</td>
                                                </tr>

                                                <tr>
                                                    <td>จำนวนคะแนนที่มอบ</td>
                                                    <td><span class="color2">50 </span>คะแนน</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="color2">อนุมัติ</span></td>
                                                </tr>
                                                <tr>
                                                    <td>วันหมดเขต</td>
                                                    <td><span class="color2">27/05/2018 (50 คะแนน)</span> </td>
                                                </tr>
                                                <tr>
                                                    <td>หัวข้อข้อความ</td>
                                                    <td><span class="color2">ทดสอบ</span></td>
                                                </tr>
                                                <tr>
                                                    <td>เนื้อหาข้อความ</td>
                                                    <td><span class="color2">ทดสอบการใช้งาน</span></td>
                                                </tr>
                                                
                                            </tbody>
                                        </table>

                                        <a class="color2 underline" href="thank-point-history.php">ย้อนกลับ</a>
                                        <div class="h30"></div>
                                    </div>
                                </div><!-- point-body -->
