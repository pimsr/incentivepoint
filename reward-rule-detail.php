                            ...
                            <div class="content bg-gray point">
                                <div class="point-wrapper">
                                    <div class="point-header">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 class="color2">รายละเอียดเกณฑ์การให้คะแนน</h6>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-point">
                                                        <thead>
                                                            ...
                                                            <th class="text-right" scope="col"><span class="color2">Demo Name</span></th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-right"><span class="color2">32</span> คะแนน</td>
                                                            </tr>

                                                            <tr>
                                                                <td scope="row">หมายเหตุ</td>
                                ...
                                <div class="h30"></div>
                                <a class="color2 underline" href="reward-rule.php">ย้อนกลับ</a>
                            </div>
                        </div>
                </div>
            </div>
