                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h6 class="color2">รายละเอียดคะแนนที่ได้รับ</h6>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-sm bg-gray">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>คะแนนเลขที่</td>
                                                            <td><span class="color2">000000002323</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>ชื่อกลุ่ม</td>
                                                            <td><span class="color2" >ICDemo</span></td>
                                                        </tr>

                                                        <tr>
                                                            <td>คะแนนที่มอบ</td>
                                                            <td><span class="color2">10</span> คะแนน</td>
                                                        </tr>

                                                        <tr>
                                                            <td>หัวข้อ</td>
                                                            <td><span class="color2">Fat to Fit : the Winner</span></td>
                                                        </tr>

                                                        <tr>
                                                            <td>หมายเหตุ</td>
                                                            <td><span class="color2">ชนะเลิศในการแข่งขัน Fat to Fit</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>วันที่ได้รับคะแนน</td>
                                                            <td><span class="color2">07/05/2018</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>คะแนนคงเหลือ</td>
                                                            <td><span class="color2">10</span> คะแนน</td>
                                                        ...
                                                        <tr>
                                                            <td>วันหมดเขต</td>
                                                            <td><span class="color2">27/05/2018</span></td>
                                                        </tr>
                                                        
                                                    </tbody>
                                                </table>

                                                <a class="color2 underline" href="reward.php">ย้อนกลับ</a>
                                                <div class="h30"></div>
                                            </div>
                                        </div>
                                    </div>
