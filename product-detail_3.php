                            ...
                            <div class="product-detail">
                                <div class="product-top bg-gray">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <h3>K380 Multi-Device Bluetooth Keyboard – Blue</h3>
                                            <div class="small">
                                                รหัสสินค้า : <span class="color3">0005800377</span> <br>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="detail" role="tabpanel" aria-labelledby="home-tab">
                                            <div class="detail py-3">
                                                ชนิดการเชื่อมต่อ: Bluetooth Classic (3.0)
                                                ระยะการเชื่อมต่อไร้สาย: 10 เมตร (30 ฟุต)*
                                                ระยะการเชื่อมต่อไร้สายอาจแตกต่างกันไป ขึ้นอยู่กับสภาวะการใช้งานและการประมวลผล
                                                Logitech K380 Multi-Device Bluetooth Keyboard (Blue)
                                                <br>
                                                <br>
                                                <p>
                                                พกพาติดตัวเพื่อการพิมพ์<br>
                                                พกพาคีย์บอร์ด Bluetooth ขนาดกะทัดรัดและน้ำหนักเบานี้ติดตัวไปทุกที่ภายในบ้านคุณ พิมพ์ได้ทุกที่ทุกเวลาที่คุณต้องการบนคอมพิวเตอร์ โทรศัพท์ หรือแท็บเล็ตที่รองรับ
                                                </p>

                                                <p>
                                                    Easy-Switch<br>
                                                    เชื่อมต่อสูงสุด 3 อุปกรณ์ในเวลาเดียวกัน เช่น คอมพิวเตอร์ Windows, โทรศัพท์ iPhone และแท็บเล็ต Android เพียงแค่แตะปุ่มครั้งเดียว เพื่อเริ่มต้นพิมพ์บนอุปกรณ์ที่ต่างออกไป

                                                </p>

                                                <p>
                                                เค้าโครงที่คุ้นเคย<br>
                                                K380 Multi-Device จดจำแต่ละอุปกรณ์ และเชื่อมโยงปุ่มต่างๆ โดยอัตโนมัติ เพื่อให้คุณได้รับเค้าโครงที่คุ้นเคย พร้อมปุ่มลัดที่คุณโปรดปราน
                                                ด้วยการตรวจจับอุปกรณ์ที่เฉพาะเจาะจง เช่น คอมพิวเตอร์ Apple หรือ Windows คีย์บอร์ดรวมนี้จะส่งรหัสคีย์ที่ถูกต้อง
                                                </p>

                                                <p>คุณสมบัติทางเทคนิค</p>
                                                <ul>
                                                    <li><strong>ชนิดการเชื่อมต่อ:</strong> Bluetooth Classic (3.0)</li>
                                                    <li><strong>ระยะการเชื่อมต่อไร้สาย: </strong> 10 เมตร (30 ฟุต)*</li>
                                                    <li>*ระยะการเชื่อมต่อไร้สายอาจแตกต่างกันไป ขึ้นอยู่กับสภาวะการใช้งานและการประมวลผล</li>
                                                    <li><strong>การสนับสนุนซอฟต์แวร์:</strong>Logitech Options สำหรับ Windows (Windows 7, Windows 8, Windows 10 หรือรุ่นใหม่กว่า) Logitech Options สำหรับ Mac (OS X 10.8 หรือรุ่นใหม่กว่า)</li>
                                                    <li><strong>แบตเตอรี่: </strong>2 x AAA</li>
                                                    <li><strong>อายุแบตเตอรี่: </strong> 24 เดือน</li>
                                                    <li><strong>ไฟสัญญาณ (LED): </strong> LED แบตเตอรี่, 3 LED ช่องสัญญาณ Bluetooth</li>
                                                    <li><strong>ปุ่มพิเศษ :</strong>  ปุ่มลัด (หน้าหลัก, กลับ, สลับโปรแกรม, เมนูตามบริบท), Easy-Switch</li>
                                                    <li><strong>เชื่อมต่อ/พลังงาน: </strong> สวิตช์เปิด/ปิด</li>
                                                </ul>
