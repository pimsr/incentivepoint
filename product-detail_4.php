                        ...
                        <div class="content">
                            ...
                            <div class="product-detail">
                                <div class="product-top bg-gray">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <img class="img-fluid" src="images/product/picture3.png" alt="">
                                        </div>
                                        <div class="col-lg-6">
                                            <h3>Toshiba Refrigerator ตู้เย็นโตชิบา GR-M25KUBZ(UK)</h3>
                                            <div class="small">
                                                รหัสสินค้า : <span class="color3">0005901006</span> <br>
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="detail" role="tabpanel" aria-labelledby="home-tab">
                                            <div class="detail py-3">
                                                <p>ตู้เย็นอินเวอร์เตอร์โตชิบา 2 ประตู รุ่น M Series ขนาด 6.8 คิว</p>
           
                                                <p>
                                                ดีไซน์เรียบหรู
                                                </p>
                                                <p>
                                                    Inverter Technology ประหยัดพลังด้วยระบบอินเวอร์เตอร์ : คอมเพรสเซอร์ในตู้เย็นรุ่นธรรมดา (Non-Inverter Compressor) มีระบบการทำงานแบบ “ตัด-ต่อ” ซึ้งจะใช้พลังงานมากในช่วงที่คอมเพรสเซอร์เริ่มทำงานใหม่ สำหรับตู้เย็นรุ่นที่เป็น Inverter Compressor นั้นจะปรับระบบการทำงานไปตามลักษณะการใช้งานที่แตกต่างกัน โดยมีเซนเซอร์ตรวจจับอุณหภูมิที่แม่นยำ ทำงานสัมพันธ์กับอุณหภูมิทั้งภายในและภายนอก ตู้เย็นคอมเพรสเซอร์จะเพิ่มความเร็วรอบในการทำงาน ถ้าอุณหภูมิยัไงม่ถึงที่กำหนดไว้และจะลดการทำงานลง เมื่อทำอุณหภูมิได้ถึงที่กำหนด ช่วงลดการตัด-ต่อของคอมเพรสเซอร์ ทำให้ประหยัดพลังงานและลดเสียงรบกวน

                                                </p>
                                                <p>
                                                ช่องเก็บผักและผลไม้ขนาดใหญ่เพื่อความสดใหม่ : เพิ่มพื้นที่การจัดเก็บผักและผลไม้ได้มากถึง 13 ลิตร ใช้งานง่าย ด้วยการออกแบบมาเป็นพิเศษ เลื่อนเข้า-ออกได้สะดวก
                                                </p>

                                                <p>
                                                ชั้นเก็บของข้างประตู ปรับตำแหน่งได้ : ตำแหน่งของที่เก็บของข้างประตู สามารถปรับเปลี่ยนได้เพื่อความสะดวกและคล่องตัว สามารถเปลี่ยนตำแหน่งที่ต้องการได้
                                                </p>

                                                 <p>
                                                ออกแบบเพื่อการทำงานที่เงียบ : ให้คุณเพลิดเพลินกับการใช้ชีวิตด้วยระบบการงานที่เงียบเสียงต่ำกว่า 33 dBA

                                                </p>
                                                
                                               <p>
                                                Hybrid Bio Deodorizer : สามารถกรองและสลายกลิ่นที่เกิดจากสารกำมะถัน ไนโตเจน และแอลดีไฮด์จากอาหาร ทำให้อากาศภายในตู้เย็นสดชื่นขึ้น นอกจากนี้สารโลหะเงินใน Hybrid Bio ยังช่วยย่อยสลายโมเลกุลของกลิ่นที่ไม่พึงประสงค์ และยับยั้งการเจริญเติบโตของแบคทีเรีย ทำให้อาหารสดนานยิ่งขึ้น

                                               </p>

                                               <p>
                                               Chiller Room Cooling : ที่สุดของช่องแช่เย็น ที่สามารถเก็บความสดของปลาและเนื้อสัตว์ ในอุณหภูมิต่ำโดยทำงานร่วมกับระบบ Hybrid Bio Deodorizer ซึ่งจะช่วยกำจัดกลิ่นอันไม่พึงประสงค์ และเพิ่มพื้นที่ ทำการจัดเก็บที่มากกว่า
</p>
                                                <p> 
                                                Cool Air Wrap System : ระบบหมุนเวียนลมเย็น ระบบหมุนเวียนลมเย็น ช่วยกระจายความเย็นและรักษาอุณหภูมิความเย็นให้คงที่ในทุกพื้นที่ของตู้เย็น ทำให้อาหารสดและได้รับความเย็นอย่างทั่วถึง

                                                
                                                    </p>
                                                <p>
                                                    Multi-Shelf Slot & Tempered Glass Shelf : ชั้นวางหลายชั้นและชั้นวางกระจกนิรภัย สามารถปรับความสูงได้หลายชั้น เพื่อความสะดวกและคล่องตัวยิ่งขึ้น ช่วยให้คุณเก็บของได้ตามต้องการ

                                                </p>

                                                <p>
                                                    LED Lighting : ทนทาน และประหยัดพลังงาน

                                                </p>
                                                <p>
                                                    รับประกันสินค้า 1 ปี รับประกันคอมเพรสเซอร์ 10 ปี
