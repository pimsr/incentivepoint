                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <h6 class="color2 mb-2">แก้ไขรหัสผ่าน</h6>
                                            <p class="mb-0">กรุณากรอกรหัสผ่านปัจจุบันและรหัสผ่านใหม่ และคลิก ”บันทึก”</p>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="hr"></div>
                                        </div>
                                ...
                                <div class="point-body form-custom pb-3">
                                    ...
                                    <div class="form-group row ">
                                        <label for="name" class="col-md-3 col-form-label"><span class="color-red">*</span>รหัสผ่านปัจจุบัน :</label>
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" id="p1">
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label for="name" class="col-md-3 col-form-label"><span class="color-red">*</span>รหัสผ่านใหม่ :</label>
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" id="p2">
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label for="name" class="col-md-3 col-form-label"><span class="color-red">*</span>ยืนยันรหัสผ่านใหม่ :</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-9">
                                            <span class="color-red">*</span> กรุณากรอกรหัสผ่านใหม่ที่ท่านต้องการและยืนยันอีกครั้ง  <br>
                                            <span class="color-red">*</span> รหัสผ่านจะต้องมีความยาว 5-15 ตัวอักษรโดยประกอบไปด้วยตัวเลขและตัวอักษรภาษาอังกฤษเท่านั้น  <br>
