                        ...
                        <div class="menu-side bg2">
                            ...
                            <div class="list-reward">
                                ...
                                <ul class="list-inline">
                                    <li class="point-thank"><a href="thank-point.php">การมอบ Thanks Point</a> </li>
                                    <li class="point-history"> <a href="thank-point-history.php">ประวัติการรับและมอบคะแนน</a></li>
                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-6 ">
                                            <h6 class="color2 mb-2">การมอบ Thanks Point</h6>
                                            <p class="mb-0">ท่านสามารถมอบ Point ให้กับผู้อื่นได้จากฟอร์มด้านล่าง</p>
                                        </div>
                                        <div class="col-sm-6 text-right">
                                            <a href="#"><img width="30" src="images/icon/icon-gray-help.png" alt=""></a>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="hr"></div>
                                        </div>
                                ...
                                <div class="point-body form-custom pb-3">
                                    ...
                                    <div class="row person">
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="search-list ">
                                                <div class="media">
                                                    <img width="60px" class="align-self-center mr-3" src="images/icon/icon-avatar.png" alt="Generic placeholder image">
                                                    <div class="media-body align-self-center color3 ">
                                                        <h5 class="my-0 color2">Demo Name</h5>
                                                        Store Manager
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mt-3">
                                        <div class="media">
                                            <img class="align-self-center mr-3" src="images/icon/icon-add.png" alt="Generic placeholder image">
                                            <div class="media-body align-self-center color3 ">
                                                เลือกทั้งหมด <span class="color2 result-selectd">0</span> คน
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="point-header pt-0">
                                    <div class="row">
                                        <div class="col-sm-6 ">
                                            <h6 class="color2 mb-2">แต้มที่จะมอบ</h6>
                                        </div>    
                                    </div>
                                </div><!-- point-header -->

                                <div class="point-body row pb-3">
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Birthday <span class="color2">(50P)</span>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Test over group thanks point <span class="color2">(1P)</span>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Thank for help  <span class="color2">(All 50P)</span>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Thanks point   <span class="color2">(Sale group only 10P)</span>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Cost down performance   <span class="color2">(1,000P)</span>
                                        </label>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="container_custom1">
                                            <input type="checkbox" >
                                            <span class="checkmark"></span>
                                            Good Corperation staff    <span class="color2">(10P)</span>
                                        </label>
                                    </div>
                                ...
                                <div class="point-body pb-3">
                                    <div class="form-group row">
                                        <div class="col-md-6"> <input placeholder="หัวข้อ" type="text" class="form-control" id="name"></div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <textarea class="form-control" placeholder="ข้อความถึงเพื่อน" name="" id="" cols="30" rows="7"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <div class="col-md-9">
                                            <button class="btn btn-1 mt-3 alert_success" type="submit">ขอบคุณ!</button>
                                        </div>
                                    </div>
                                </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body text-center">
                     <img src="images/icon/icon-check.png">
                      <h4 class="color2 mt-4">บันทึกข้อมูลเรียบร้อย</h4>
              </div>
            ...
            $('.search-list').click(function() {
                ...
                if($(this).hasClass('active'))
                {
                    ...
                    $(this).find("input").prop('checked', false);
                     $('.result-selectd').html($('input[type="checkbox"]:checked').length);
                }
                else
                {
