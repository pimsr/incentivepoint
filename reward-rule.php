                            ...
                            <div class="content bg-gray point">
                                <div class="point-wrapper">
                                    <div class="point-header">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 class="color2">เกณฑ์ของ Award Point ในระบบ</h6>
                                            </div>
                                            ...
                                            <div class="col-sm-12">                                    
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-point">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td scope="row"><span class="color2">Demo Name</span></td>
                                                                <td><span class="color2">32</span> คะแนน</td>
                                                                <td><a href="reward-rule-detail.php"><span class="color2">คลิกเพื่อดู</span></a></td>
                                                            </tr>
