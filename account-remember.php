                        ...
                        <div class="content bg-gray point">
                            <div class="point-wrapper">
                                <div class="point-header">
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <h6 class="color2 mb-2">ใช้ระบบช่วยจำรหัสผ่าน</h6>
                                            <p class="mb-0">
                                                การลงทะเบียนใช้ระบบช่วยจำรหัสผ่าน <br>
                                                ท่านจะต้องใช้ข้อมูลด้านล่างนี้ในการตั้งค่ารหัสผ่านใหม่กรณีที่ท่านลืมรหัสผ่าน <br>
                                                กรุณากรอกข้อมูลให้สมบูรณ์และ คลิก <span class="color2">“บันทึก”</span>
                                ...
                                <div class="point-body form-custom pb-3">
                                    ...
                                    <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3">ล็อกอินไอดี :</div>
                                            <div class="col-md-9">Demo</div>
                                        </div>
                                    </div>
                                    <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3">ชื่อ - นามสกุล :</div>
                                            <div class="col-md-9">John Due</div>
                                        </div>
                                    </div>
                                    <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3"><span class="color-red">*</span>อีเมล :</div>
                                    ...
                                    <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3"><span class="color-red">*</span>ยืนยันอีเมล :</div>
                                            <div class="col-md-9"> <input type="text" class="form-control" id="name"></div>
                                        </div>
                                    </div>
                                    <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3"><span class="color-red">*</span>คำถามลับ :</div>
                                            <div class="col-md-3">
                                     ...
                                     <div class="info-list mb-3">
                                        <div class="row">
                                            <div class="col-md-3"><span class="color-red">*</span>คำตอบ :</div>
                                            <div class="col-md-9"> <input type="text" class="form-control" id="name"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-9">
                                            <span class="color-red">*</span> กรุณากรอกข้อมูลให้ครบถ้วนเพื่อประโยชน์ของตัวท่านเอง  <br>
                                            <button class="btn btn-1 mt-3" type="submit">บันทึก</button>
                                        </div>
                                    </div>
