                            ...
                            <div class="content bg-gray point">
                                <div class="point-wrapper">
                                    <div class="point-header">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 class="color2">ตรวจสอบคะแนน</h6>
                                            </div>
                                            <div class="col-sm-6 text-right">รวมคะแนนที่ได้รับ <span class="color2">1,203</span> คะแนน</div>
                                            <div class="col-sm-12">
                                                <div class="hr"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">                                    
                                            <div class="table-responsive">
                                                <table class="table table-striped table-point">
                                                    <thead>
                                                        <tr>
                                                        <th scope="col">ประเภทคะแนน</th>
                                                        <th scope="col">วันที่ได้รับคะแนน</th>
                                                        <th scope="col">คะแนนที่ได้รับ</th>
                                                        <th scope="col">คงเหลือ</th>
                                                        <th scope="col">วันหมดเขต</th>
                                                        <th scope="col">รายละเอียด</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td scope="row"><span class="color2">Lorem Ipsum</span></td>
                                                            <td>วันที่ <span class="color2">12/01/2018</span></td>
                                                            <td><span class="color2">345</span> คะแนน</td>
                                                            <td><span class="color2">123</span> คะแนน</td>
                                                            <td>วันที่ <span class="color2">12/01/2018</span></td>
                                                            <td><a href="reward-detail.php"><span class="color2">ดูรายละเอียด</span></a></td>
                                                        </tr>
